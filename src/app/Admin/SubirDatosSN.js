...
export const SubirEncabezadoSN = () => {
  ...
  useEffect(() => {
    const fetchEncabezado = async () => {
      try {
        const docRef = doc(db, "textoSN", "apartado0");
...
export const SubirDatosSN1 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const docRef = doc(db, "textoSN", "apartado1");
        const docSnap = await getDoc(docRef);
...
export const SubirDatosSN2 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const docRef = doc(db, "textoSN", "apartado2");
        const docSnap = await getDoc(docRef);
...
export const SubirDatosSN3 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const docRef = doc(db, "textoSN", "apartado3");
        const docSnap = await getDoc(docRef);
