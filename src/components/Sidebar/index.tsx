...
const menuGroups = [
  {
    ...
    menuItems: [
     ...
     
      {
        ...
        label: "Aplica para empleos",
        route: "#",
        children: [
          { label: "Ingresa Curriculum", route: "/forms/form-layout" },
        ],
      },
      {
        icon: (
        ...
        label: "Gestion Empelador",
        route: "#",
        children: [
          { label: "Ver Curriculums", route: "/tables" },
          { label: "Tu Oferta de Empleo", route: "/forms/form-elements" },
        ],
      },
      {
